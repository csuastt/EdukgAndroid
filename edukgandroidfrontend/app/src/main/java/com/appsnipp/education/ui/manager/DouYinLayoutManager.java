package com.appsnipp.education.ui.manager;

/***
 * This is the douyin layout manager page.
...
import com.appsnipp.education.ui.listeners.OnViewPagerListener;
    ...
    public void onChildViewAttachedToWindow(@NonNull View view) {
        if (mDrift > 0){
            ...
            if (onViewPagerListener != null && Math.abs(mDrift) == view.getHeight()){
                onViewPagerListener.onPageSelected(view, false);
            }
        }else {
            //向下滑
            if (onViewPagerListener != null && Math.abs(mDrift) == view.getHeight()){
                onViewPagerListener.onPageSelected(view, true);
            }
        }
    }
    ...
    public void onScrollStateChanged(int state) {
        switch (state){
            case RecyclerView.SCROLL_STATE_IDLE:
                ...
                if (onViewPagerListener != null){
                    onViewPagerListener.onPageSelected( snapView,false);
                }
                break;
        }
