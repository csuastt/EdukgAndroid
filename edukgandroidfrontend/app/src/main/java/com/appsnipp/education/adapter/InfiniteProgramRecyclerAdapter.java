...
public class InfiniteProgramRecyclerAdapter extends RecyclerView.Adapter<InfiniteProgramRecyclerAdapter._ViewHolder> {

    Context mContext;
    private List<Question> mData;
    private QuestionItemClickListener questionItemClickListener;

    public InfiniteProgramRecyclerAdapter(Context mContext, List<Question> mData, QuestionItemClickListener listener) {
    ...
    @NonNull
    @Override
    public InfiniteProgramRecyclerAdapter._ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final InfiniteProgramRecyclerAdapter._ViewHolder viewHolder, final int i) {
